...
This Nova extension is under sporadic development. Time and effort are finite, and I have other things I want to work on. That said, I welcome pull requests at this project's GitHub repository. If you'd like to contribute, please do so!
...
- Tree Sitter project for an MIT-licensed Julia grammar, from which the `libtree-sitter-julia.dylib` was generated (a copy of the license for this is in `Syntaxes/LICENSE`) (https://github.com/tree-sitter/tree-sitter-julia)
